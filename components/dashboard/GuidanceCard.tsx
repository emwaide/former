...
export const GuidanceCard = ({ message, actionLabel, onAction }: GuidanceCardProps) => (
  <View
    className="flex-row items-start gap-4 rounded-[20px] border p-6 shadow-soft"
    style={{
      borderColor: colorWithOpacity('teal', 0.25),
      backgroundColor: colorWithOpacity('cyan', 0.16),
    }}
  >
    ...
    <View className="flex-1 gap-2">
      ...
      {actionLabel && onAction ? (
        ...
        >
          <Text className="text-[12px] font-[Poppins_600SemiBold] uppercase tracking-[0.8px] text-surface">
            {actionLabel}
          </Text>
        </Pressable>
      ) : null}
