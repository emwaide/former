...
export const lightTokens: ThemeTokens = {
  ...
  colors: {
    ...
    gradient: ['#F8F9FA', '#F0F1F2'],
    heroGradient: [palette.card, palette.card, palette.card],
    guidanceGradient: [palette.skyTint, palette.card],
    streakGradient: [palette.blueMid, palette.blueLight],
    ringGradient: [palette.blueMid, palette.blueLight],
